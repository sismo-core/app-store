...
export const sismoAppsTutorialsConfig: SpaceConfig = {
  ...
  description: "This Sismo Apps Tutorials space serves to showcase offchain and onchain tutorials to Sismo Builders.",
  ...
  apps: [
    {
      ...
      spreadsheetId: "0x040a317391d3a897e9910ee31c9b88ba",
      claimRequests: [
        {
